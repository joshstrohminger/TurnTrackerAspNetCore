...
namespace TurnTrackerAspNetCore.Migrations
{
    ...
    [Migration("20161218104457_Optional Invite Properties")]
    partial class OptionalInviteProperties
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TurnTrackerAspNetCore.Entities.Invite", b =>
                {
            ...
            modelBuilder.Entity("TurnTrackerAspNetCore.Entities.SiteSetting", b =>
                {
                    b.Property<string>("Name")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(500);
            ...
            modelBuilder.Entity("TurnTrackerAspNetCore.Entities.Invite", b =>
                {
                    b.HasOne("TurnTrackerAspNetCore.Entities.User", "Invitee")
                        .WithMany()
                        .HasForeignKey("InviteeId");

                    b.HasOne("TurnTrackerAspNetCore.Entities.User", "Inviter")
                        .WithMany()
