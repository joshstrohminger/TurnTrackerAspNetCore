...
paths.js = webroot + 'js/**/*.js';
paths.minJs = webroot + 'js/**/*.min.js';

paths.css = webroot + 'css/**/*.css';
paths.minCss = webroot + 'css/**/*.min.css';

paths.concatJsDest = webroot + 'js/site.min.js';
paths.concatCssDest = webroot + 'css/site.min.css';
